...
class ChangePasswordView(View):
    ...
    def _init_ui_components(self):
        ...
        self.mayuscula_text = ft.Text(
            "Al menos 1 mayúscula", color=ft.Colors.RED_ACCENT_700, size=14
        )
        ...
        self.minuscula_text = ft.Text(
            "Al menos 1 minúscula", color=ft.Colors.RED_ACCENT_700, size=14
        )
        ...
        self.digito_text = ft.Text(
            "Al menos 1 dígito", color=ft.Colors.RED_ACCENT_700, size=14
        )
        ...
        self.caracter_especial_text = ft.Text(
            "Al menos 1 caracter especial", color=ft.Colors.RED_ACCENT_700, size=14
        )
    ...
    def _build_requisitos_section(self):
        return CustomContainer(
            ...
            border_radius=8,  # Bordes redondeados para mejor apariencia
        )
